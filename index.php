                    ...
                    <div class="card-body p-4">
                        <form action="dashboard/admin/authentication/admin-class.php" method="POST">
                            ...
                            <div class="d-grid mt-4">
                                <button type="submit" class="btn btn-primary py-2" name="btn-signin">Sign In</button>
                            </div>
                        </form>
                    </div>

                    <div class="card-footer bg-white py-3 text-center">
                        <p class="text-decoration-none form-links">Don't have an account? <a class="text-decoration-none form-links" href="signup.php">Sign up</a></p>
                    </div>
                </div>
            </div>
        </div>
